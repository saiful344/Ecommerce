				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="<?= base_url();?>assets/images/<?= $content['foto'] ?>" alt="">
							</div>
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name"><?= $content['nama'] ?></h2>
							<h3 class="product-price">$ <?= $content['harga'] ?> <del class="product-old-price">$45.00</del></h3>
							<div>
							...
							<p><strong>Availability:</strong> <?= $content['stok'] ?></p>
							<p><strong>Brand:</strong><?= $content['jenis'] ?></p>
